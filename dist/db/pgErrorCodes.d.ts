...
export declare function isPostgresError(error: any, code: PostgresErrorCode): boolean;
export declare function isUniqueViolationError(error: any): boolean;
export declare function isForeignKeyViolationError(error: any): boolean;
...
//# sourceMappingURL=pgErrorCodes.d.ts.map