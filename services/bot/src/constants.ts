...
export const REPORT_BAN_EVASION =
  "Ban Evasion, duplicate account or impersonation";
...
export const REPORT_SCAM_ILLEGAL_SERVICES =
  "Scam, fraud or illegal services / cheating";
