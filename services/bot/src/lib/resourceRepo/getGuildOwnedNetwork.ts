...
export default function getGuildOwnedNetworkRepository(
  sql: Sql,
): GetGuildOwnedNetworkFunction {
  return async function getGuildOwnedNetwork(
    guildId: string,
  ): Promise<GetGuildOwnedNetworkResult> {
